...
#
# O objetivo da simulação é separar as funções componentes. Foi considerado um
# erro normal. Além disso, também é utilizado I = 50 (tamanho da amostra) e 500
# replicações. Com relação às ondaletas, foi utilizado filter.number=5 e
# family='DaubExPhase' e a polistica de escolha de limiar 'sure'.
